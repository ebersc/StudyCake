...
class EmployeesFixture extends TestFixture
{
    ...
    public $fields = [
        'EmployeeID' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['EmployeeID'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
